...
public class ProfileFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    PreviewPostsAdapter.OnClickListener onClickListener =
        new PreviewPostsAdapter.OnClickListener() {
          @Override
  ...
  private void launchCamera() {
    ...
    Uri fileProvider =
        FileProvider.getUriForFile(getContext(), "com.codepath.fileprovider", profilePictureFile);
