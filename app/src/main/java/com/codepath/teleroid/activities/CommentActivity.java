    ...
    binding.postButton.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            if (binding.inputComment.getText().toString().trim().equals("")
                || binding.inputComment.getText() == null) {
              Toast.makeText(CommentActivity.this, "Comment can't be empty", Toast.LENGTH_SHORT)
                  .show();
              return;
            }
